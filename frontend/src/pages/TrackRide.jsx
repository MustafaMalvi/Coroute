...
// picks out the rides worth showing on the "which ride do you want to track" screen —
// a host cares about rides that are happening today or still coming up, a partner
// cares about the bookings they're actually going to ride on
  ...
  useEffect(() => {
    const load = async () => {
      try {
        ...
        // picker just stays empty on failure — the map itself isn't affected
      } finally {
        setLoading(false);
      }
    };
